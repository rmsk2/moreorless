...
-- This code tests whether list.insertBefore and list.setCurrentLine work as expected. For this a new list
-- with three elements is created by calling list.insertBefore. The assembly test driver then exports 
-- "far pointers" to all three elments, the list length as a word and the memory management data structures. 
-- The assembly part also tests whether the new beginning of the list is correctly signalled when calling list.prev.
